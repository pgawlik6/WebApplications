    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                   ...
                   <hr> <h2 class="brand-before">
                        <small>Welcome to</small>
                    </h2>
                    
                    <h1 class="brand-name">Natural IT</h1>
                    <hr>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">HOW TO CHOOSE 
                        <strong>THE BEST IT COMPANY?</strong>
                    </h2>
                    <hr>
                    <img class="img-responsive img-border img-left" src="img/home_img.jpg" alt="">
                    <hr class="visible-xs">
