...
<head>
    ...
    <title>Natural IT - Register</title>
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        if (html == 'true') {
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Password</strong> must contain at least 4 characters . \ \
                                                 </div>');
                    ...
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="password" id="password" name="password" maxlength="200" class="form-control" placeholder="Password">
                            </div>
                            <div class="form-group col-lg-12">
